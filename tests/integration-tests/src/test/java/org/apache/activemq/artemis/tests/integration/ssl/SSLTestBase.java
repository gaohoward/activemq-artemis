...
public abstract class SSLTestBase extends ActiveMQTestBase {
   ...
   protected String SERVER_SIDE_KEYSTORE = "server-side-keystore.jks";
   protected String SERVER_SIDE_TRUSTSTORE = "server-side-truststore.jks";
   protected String CLIENT_SIDE_TRUSTSTORE = "client-side-truststore.jks";
   protected String CLIENT_SIDE_KEYSTORE = "client-side-keystore.jks";
